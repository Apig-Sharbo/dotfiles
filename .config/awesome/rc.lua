...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            -- mykeyboardlayout,
            separator1,
            awful.widget.watch('bash -c "~/.local/bin/statusbar/brightness-script"', 1),
            separator2,
            awful.widget.watch('bash -c "~/.local/bin/statusbar/volume"', 1),
            separator2,
            awful.widget.watch('bash -c "~/.local/bin/statusbar/clock"', 1),
            separator2,
